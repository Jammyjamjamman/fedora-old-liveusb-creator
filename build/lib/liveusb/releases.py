...
fedora_releases = [
{'releaseDate': '', 'source': 'Local', 'name': 'Custom OS...', 'logo': 'qrc:/icon-folder.svg', 'variants': {'': {'url': '', 'sha256': '', 'size': 0}}, 'summary': 'Pick a file from your drive(s)', 'screenshots': [], 'description': 'Here you can choose a OS image from your hard drive to be written to your flash disk'},
